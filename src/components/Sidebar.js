...
import { 
  View, Text, TouchableOpacity, StyleSheet, Image, Modal, TouchableWithoutFeedback 
} from 'react-native';
...
export default function PatientSidebar({ isVisible, onClose, navigation }) {
  ...
  const confirmSignOut = () => {
    ...
    onClose();
    // FIX: Reset the navigation stack to the Auth flow
    navigation.reset({
      index: 0,
      routes: [{ name: 'Auth' }],
    });
      ...
      <Modal animationType="fade" transparent={true} visible={isVisible} onRequestClose={onClose}>
        <View style={styles.modalOverlay}>
           ...
           <View style={styles.sidebarContainer}>
              ...
              <Text style={styles.sidebarName}>Sara Shetty</Text>
